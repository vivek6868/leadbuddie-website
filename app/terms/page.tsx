    ...
    <Section className="pt-24 pb-16 md:pt-32 md:pb-24 bg-bg-secondary">
      <div className="max-w-4xl mx-auto">
        <div className="mb-10 text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold text-text-primary tracking-tight mb-4">Terms of Service</h1>
        </div>

        <div className="space-y-8">
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">1. Agreement to Terms</h2>
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">2. Description of Service</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">3. Account Registration</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">4. Acceptable Use Policy</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">5. WhatsApp Usage Policy</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
              <strong className="text-text-primary">Critical: Compliance with Meta/WhatsApp Policies</strong>
            </p>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">5.1 Prohibited Activities</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">5.2 Your Responsibility</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">6. Payment Terms</h2>
            ...
            <h3 className="text-lg font-bold text-text-primary mb-2 mt-4">6.3 Payment Processing</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-2 mt-4">6.4 Price Changes</h3>
            <p className="text-text-secondary leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">8. Account Termination</h2>
            ...
            <ul className="list-disc list-inside space-y-2 text-text-secondary mb-4 ml-4 leading-relaxed font-medium">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-2 mt-4">8.3 Effect of Termination</h3>
            <p className="text-text-secondary leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">9. Intellectual Property</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">10. Limitation of Liability</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <p className="text-text-secondary leading-relaxed bg-bg-secondary border border-border p-4 rounded-2xl font-medium mt-4 text-center">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">11. Dispute Resolution</h2>
            <h3 className="text-lg font-bold text-text-primary mb-2 mt-4">11.1 Governing Law</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
              These Terms shall be governed by and construed in accordance with the laws of India, without 
              regard to its conflict of law provisions.
            </p>

            <h3 className="text-lg font-bold text-text-primary mb-2 mt-4">11.2 Dispute Resolution Process</h3>
            <p className="text-text-secondary leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">12. Changes to Terms</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">13. Contact Information</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
              If you have any questions about these Terms of Service, please contact us:
            </p>
            <ul className="list-none space-y-2.5 text-text-secondary leading-relaxed font-medium">

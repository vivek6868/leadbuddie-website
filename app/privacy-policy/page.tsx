    ...
    <Section className="pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-b from-dark-950 via-dark-900 to-dark-950">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 md:mb-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white tracking-tight">Privacy Policy</h1>
          <p className="text-white text-sm md:text-base">Last updated: {LAST_UPDATED}</p>
        </div>

        <div className="max-w-none space-y-8 [&_p]:!text-white [&_li]:!text-white">
          ...
          <div className="bg-dark-800/70 border border-dark-700 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4 text-white">2.1 Information You Provide</h3>
            <p className="text-gray-200 mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4 text-white">2.2 Information Automatically Collected</h3>
            <p className="text-gray-200 mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4 text-white">2.3 WhatsApp Data</h3>
            <p className="text-gray-200 mb-4 leading-relaxed">
          ...
          <div className="bg-dark-800/70 border border-dark-700 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4 text-white">4.1 Meta/WhatsApp Business API</h3>
            <p className="text-gray-200 mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4 text-white">4.2 Cloud Infrastructure</h3>
            <p className="text-gray-200 mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4 text-white">4.3 AI Services</h3>
            <p className="text-gray-200 mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4 text-white">4.4 Payment Processing</h3>
            <p className="text-gray-200 leading-relaxed">
          ...
          <div className="bg-dark-800/70 border border-dark-700 rounded-2xl p-6 md:p-8 shadow-lg">
            <h2 className="text-2xl font-semibold mb-4 text-white">5. WhatsApp Data Handling</h2>
            <p className="text-gray-200 mb-4 leading-relaxed">
          ...
          <div className="bg-dark-800/70 border border-dark-700 rounded-2xl p-6 md:p-8 shadow-lg">
            <h2 className="text-2xl font-semibold mb-4 text-white">9. Cookies and Tracking Technologies</h2>
            <p className="text-gray-200 mb-4 leading-relaxed">
          ...
          <div className="bg-dark-800/70 border border-dark-700 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <ul className="list-none space-y-2 text-gray-100 leading-relaxed">
              <li><strong>Email:</strong> <a href={`mailto:${CONTACT.general}`} className="text-primary-300 hover:text-primary-200 font-semibold underline underline-offset-2">{CONTACT.general}</a></li>

    ...
    <Section className="pt-24 pb-16 md:pt-32 md:pb-24 bg-bg-secondary">
      <div className="max-w-4xl mx-auto">
        <div className="mb-10 text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold text-text-primary tracking-tight mb-3">Privacy Policy</h1>
          <p className="text-sm md:text-base text-text-secondary">Last updated: {LAST_UPDATED}</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">2. Information We Collect</h2>
            
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">2.1 Information You Provide</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
              When you register for an account or use our Service, we may collect the following information:
            </p>
            <ul className="list-disc list-inside space-y-2.5 text-text-secondary mb-5 ml-4 leading-relaxed font-medium">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">2.2 Information Automatically Collected</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">2.3 WhatsApp Data</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <p className="text-text-secondary leading-relaxed bg-bg-secondary border border-border p-4 rounded-2xl font-medium mt-4">
              <strong className="text-text-primary">Important:</strong> We only access WhatsApp data that you explicitly authorize us to access. 
              We do not access data from personal WhatsApp accounts, only WhatsApp Business accounts that you connect to our Service.
            </p>
          </div>

          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">3. How We Use Your Information</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
              We use the information we collect for the following purposes:
            </p>
            <ul className="list-disc list-inside space-y-2.5 text-text-secondary ml-4 leading-relaxed font-medium">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">4. Third-Party Services</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
              We use the following third-party services to operate our platform:
            </p>
            
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">4.1 Meta/WhatsApp Business API</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">4.2 Cloud Infrastructure</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">4.3 AI Services</h3>
            <p className="text-text-secondary mb-4 leading-relaxed">
            ...
            <h3 className="text-lg font-bold text-text-primary mb-3 mt-5">4.4 Payment Processing</h3>
            <p className="text-text-secondary leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">5. WhatsApp Data Handling</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
              <strong className="text-text-primary">Critical Information for Meta/WhatsApp Compliance:</strong>
            </p>
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">6. Data Security</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">7. Your Rights</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">8. Data Retention</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">9. Cookies and Tracking Technologies</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">10. Children's Privacy</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">11. International Data Transfers</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">12. Changes to This Privacy Policy</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">
          ...
          <div className="bg-bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-4">13. Contact Us</h2>
            <p className="text-text-secondary mb-4 leading-relaxed">

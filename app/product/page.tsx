  ...
  return (
    <>
      ...
      <Section className="pt-32 pb-16">
        <SectionHeader
          title="Everything your AI co-pilot does — under one roof."
          description="Inbox, pipeline, follow-ups, AI replies, and campaigns. Each capability is opt-in and transparent. You stay in control."
          centered
        />
      </Section>

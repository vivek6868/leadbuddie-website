      ...
      <section className="relative isolate min-h-[760px] overflow-hidden bg-[#07111f] px-4 pb-20 pt-28 text-white sm:px-6 md:pt-36 lg:px-8">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg text-[1.03rem] leading-relaxed text-slate-300 sm:text-lg">LeadBuddie helps move WhatsApp enquiries to the right next step: an answer grounded in your business, a qualified lead, a quote or booking request, or a clean handover to your team.</p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row"><TrialButton /><Link href="/demo" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/[0.06] px-5 py-3 text-sm font-bold text-white transition hover:bg-white/[0.12]"><span className="grid h-5 w-5 place-items-center rounded-full border border-white/40 text-[8px]">▶</span> Watch product demo</Link></div>
            <div className="mt-7 flex flex-wrap gap-x-4 gap-y-2 text-xs text-slate-400"><span className="inline-flex items-center gap-1.5"><Check className="h-3.5 w-3.5 text-[#70ec99]" /> Built on the WhatsApp Business Platform</span><span className="inline-flex items-center gap-1.5"><Check className="h-3.5 w-3.5 text-[#70ec99]" /> No card to start</span></div>
          </div>

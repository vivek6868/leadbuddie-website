...
/**
 * The guides listing, shared by /blog and /blog/category/[category].
 *
 * It takes the category as a prop rather than reading a query string, which is what lets both
 * routes prerender as static HTML. Each route supplies its own metadata and structured data.
 */
export function BlogIndex({ category }: { category?: BlogCategory }) {

...
export function AiEmployeePage() {
  return (
    <div className="bg-bg-primary text-text-primary">
      ...
      <section className="bg-[#091321] px-4 py-20 sm:px-6 lg:px-8 lg:py-28"><div className="mx-auto max-w-3xl"><p className="text-center text-[11px] font-bold uppercase tracking-[0.15em] text-[#82f3a7]">Questions before you start?</p><h2 className="mt-4 text-center font-heading text-4xl font-extrabold leading-[0.98] tracking-[-0.055em] text-white sm:text-5xl">Understand the workflow first.</h2><FAQAccordion items={FAQS} tone="dark" className="mt-10" /><div className="mt-10 text-center"><Link href="/contact" className="inline-flex items-center gap-2 text-sm font-bold text-[#91f5af] hover:text-white">Talk through your use case <ArrowRight className="h-4 w-4" /></Link></div></div></section>
    </div>
  )
}
